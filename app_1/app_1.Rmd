...
- _Step 1_ -> Seleziona parola_1 e parola2. L'ordine non conta. 
- _Step 2_ -> Specifica il _dizionario stopwords_ associare al paese (/alla lingua), cioè la Germania, l'Inglese (sì, il piano è scritto in inglese), per la Francia, il francese.
- _Step 3_ -> Salvare plot tramite il bottone in basso. Molto in basso. `r emo::ji("low")` 
...
downloadHandler(
  filename = function() {
    glue::glue("{input$prima_parola}_{input$seconda_parola}_{input$country}.pdf")
  },
