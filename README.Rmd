...
- app 1: esplorare i **Trigrammi**: [deploy](https://niccolosalvini.shinyapps.io/app_2/)
- app 3: netowork di **Bigrammi**: [deploy](https://niccolosalvini.shinyapps.io/app_3/)
...
Apri il file di progetto nella cartella clonata `textmining_OI.Rproj`, successivamente compila il documento `main.R` col comando **knit**  
